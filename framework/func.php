...
{   
	...
	{
        ?>
<input name="<?php echo $nama?>" type="text" id="<?php echo $nama?>" class="<?php echo $class ?>" value="<?php echo $value ?>" <?php echo chk($info) ?>/>
	    <?php 
	}
	else
	{
        ...
        <?php
            if(chk($id_upload)!='')
            {
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-addon"><a href="action.dload?id=<?php echo emenu($key, $id_upload) ?>" target="_blank"><i class="ace-icon fa fa-download" title="Download"></i></a></div>
                    <div class="input-group-addon"><a href="<?php echo $action."&id_upload=$id_upload" ?> "><i class="ace-icon fa fa-remove red" title="Remove"></i></a></div>
                </div>            
                <?php
            }
    }
