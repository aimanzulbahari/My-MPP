        ...
        <body>
            ...
            <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
                ...
                <div id="header" class="header navbar navbar-default navbar-fixed-top">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                            <a href="action.do" class="navbar-brand"><span class="navbar-logo"><i class="ion-ios-cloud"></i></span> <b>My</b>MPP</a>
                ...
                <div id="content" class="content">
                    ...
                    if ($_SESSION[$GLOBALS['fw_sistem']]['username'] != '') {
                        if (file_exists($fail)) {
                            $_SESSION['keyrefresh']= $keybefore.'|'.$_GET['do'];
                        } else {
                            $arr_refresh = explode('|',$_SESSION['keyrefresh']);
                            $_SESSION['keyrefresh']= $arr_refresh[0].'|'.$arr_refresh[1];
                            $do = dmenu($arr_refresh[0],$arr_refresh[1]);
                            $fail = "$do.php";
                        }
                        include("$fail");
                    } else {
