...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-plugins-10">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><span class="label label-success pull-left m-r-10">NEW</span> Standard Form</h4>
            </div>
            <div class="panel-body panel-form">
                <form class="form-horizontal form-bordered">
                    <div class="form-group">
                        <label class="col-md-2 control-label">
                            <?php echo lbl('Text Field') ?></label>
                        <div class="col-md-10">
                            <input name="name" value="<?php echo @$name ?>" class="form-control <?php echo FwSemak::alert_semak(@$chk_name) ?>">
                        <?php
                            echo '<textarea rows="8" cols="81"><div class="form-group">
    ...
    <div class="col-md-8">
        <input name="name" value="<?php echo @$name ?>" class="form-control <?php echo FwSemak::alert_semak(@$chk_name) ?>">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2">Droplist</label>
                        <div class="col-md-10">
                            <?php
                            $sql = 'SELECT rr_acronym, rr_description FROM ref_role';
                                Db::droplist($sql, 'droplist', 'rr_acronym', 'rr_description', @$select);
                                
                            echo '<textarea rows="7" cols="81"><div class="form-group">
    <label class="col-md-4 control-label"><?php echo lbl(\'Droplist\') ?></label>
    <div class="col-md-8">
    $sql = \'SELECT rr_acronym, rr_description FROM ref_role\';
    Db::droplist($sql, \'name\', \'rr_acronym\', \'rr_description\', @$select);
    </div>
</div</textarea>';    
                            ?>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2">Droplist Select 2</label>
                        <div class="col-md-10">
                            <?php
                            $sql = 'SELECT rr_acronym, rr_description FROM ref_role';
                                Db::droplist($sql, 'droplist', 'rr_acronym', 'rr_description', @$select,'default-select2 form-control');
